...
const allSections: GallerySection[] = [
  {
    ...
    images: [
      ...
      { file: '/img/gallery/g27237.jpg', alt: 'Gray wasp nest paper plastered over the dome lid and top of a propane tank, beside the tank\'s black flexible gas line', width: 560, height: 420 },
      ...
      { file: '/img/gallery/g27230.jpg', alt: 'A closer view of the same gray wasp nest tucked into the gable peak, under the rake boards above a diamond-paned window', width: 560, height: 420 },
      { file: '/img/gallery/g27224.jpg', alt: 'A removed wasp nest broken up inside a white plastic garbage bag, its layered paper envelope and combs showing', width: 560, height: 420 },
      { file: '/img/gallery/g27157.jpg', alt: 'A black-and-yellow wasp on the lid of a gray plastic box outdoors, beside a black post and orange mesh fencing', width: 560, height: 747 },
      { file: '/img/gallery/g27156.jpg', alt: 'A black-and-yellow wasp on a red speckled dome set on a flat gray surface', width: 560, height: 747 },
  ...
  },
  {
    ...
    images: [
      /* Refiled 21 Sep 2026: the applicator reads MGK Vendetta Nitro, a cockroach
         gel bait, so this is roach work, not rodent work. */
      { file: '/img/gallery/g27137.jpg', alt: 'A gloved hand using an applicator gun on the joint under a shelf inside a white cabinet, a textured liner below', width: 560, height: 747 },
      /* Owner's own, 19 Sep 2026. */
      ...
      /* Refiled 21 Sep 2026 by the photo audit: a cockroach, filed under Rodent work and labeled as a rodent. */
      { file: '/img/gallery/g27101.jpg', alt: 'A cockroach with long antennae and a banded abdomen walking along a narrow ledge below a tan panel', width: 560, height: 747 },
      /* Refiled 21 Sep 2026 by the photo audit: the same cockroach by flashlight, filed under Rodent work as a rodent. */
      { file: '/img/gallery/g27100.jpg', alt: 'The same cockroach on the ledge lit by a flashlight, its long antennae and banded abdomen casting a shadow', width: 560, height: 747 },
      { file: '/img/gallery/g27093.jpg', alt: 'Carpenter ant frass accumulated on wood framing in a crawlspace', width: 560, height: 747 },
      /* Refiled 21 Sep 2026 by the photo audit: ants on a fence rail, filed under Exclusion as a deck-and-siding gap. */
      { file: '/img/gallery/g27108.jpg', alt: 'Two or three black ants on the red-stained bottom rail of a wooden fence, with weeds growing below', width: 560, height: 747 },
      ...
      { file: '/img/gallery/g26767.jpg', alt: 'A praying mantis on a vehicle windshield, seen from inside the cab, with the dashboard and defroster vents below', width: 560, height: 415 },
      ...
      { file: '/img/gallery/g26765.jpg', alt: 'A praying mantis on a vehicle windshield seen from inside, the dashboard below and the sun behind it', width: 560, height: 415 },
    ],
  },
  {
    key: 'rodents',
    ...
    images: [
      ...
      /* Refiled 21 Sep 2026 by the photo audit: rodent-chewed foam at the same spot as g26949, filed under Insulation. */
      { file: '/img/gallery/g26950.jpg', alt: 'White-faced rigid foam gnawed ragged by rodents, chewed crumbs scattered over it and a screwed board edged with blue tape', width: 560, height: 420 },
      /* Owner's own, 19 Sep 2026. */
      ...
      { file: '/img/gallery/g27227.jpg', alt: 'A rotten form board in a crawlspace with a blue vapor barrier, allowing rodent access', width: 560, height: 747 },
      ...
      { file: '/img/gallery/g27111.jpg', alt: 'Rodent droppings and debris at a door threshold', width: 560, height: 747 },
      ...
      /* Refiled 21 Sep 2026 by the photo audit: a bucket rodent trap in a garage, filed under Crawlspaces. */
      { file: '/img/gallery/g27110.jpg', alt: 'A bucket trap in a garage corner, a ridged plank leaning up to its rim and a lidded plate across the top', width: 560, height: 747 },
      /* Refiled 21 Sep 2026 by the photo audit: mouse droppings in a utility room, filed under Crawlspaces. */
      { file: '/img/gallery/g27078.jpg', alt: 'Mouse droppings scattered over the top of an appliance in a utility room, among loose fittings and a metal ring', width: 560, height: 747 },
    ],
  },
  {
    key: 'insulation',
    title: 'Insulation',
    images: [
      { file: '/img/gallery/g27149.jpg', alt: 'Pink insulation in a crawlspace', width: 560, height: 747 },
      { file: '/img/gallery/g27148.jpg', alt: 'A piece of pink insulation on a dark vapor barrier in a crawlspace', width: 560, height: 747 },
      ...
      { file: '/img/gallery/g27060.jpg', alt: 'HVAC flex ducts in torn black plastic jackets, fiberglass showing, hung from straps under yellow batts in a crawlspace', width: 560, height: 420 },
      ...
      { file: '/img/gallery/g26993.jpg', alt: 'A black ABS drain fitting running through a concrete foundation wall, with broken concrete and a gap around the hole', width: 560, height: 747 },
      ...
      { file: '/img/gallery/g26926.jpg', alt: 'Old pink batts torn and hanging in shreds from the floor joists of a crawlspace, above black sheeting and wood posts', width: 560, height: 420 },
      { file: '/img/gallery/g26925.jpg', alt: 'Subfloor insulation in a crawlspace', width: 560, height: 420 },
    ],
  },
  {
    key: 'crawlspaces',
    ...
    images: [
      ...
      { file: '/img/gallery/g27170.jpg', alt: 'A wooden crawlspace access door on a home\'s foundation', width: 560, height: 560 },
      ...
      { file: '/img/gallery/g26708.jpg', alt: 'A technician in a full-face respirator with pink filters and a headlamp, ready for crawlspace work', width: 560, height: 746 },
      { file: '/img/gallery/g27160.jpg', alt: 'White fungal growth on wood in a crawlspace', width: 560, height: 747 },
      { file: '/img/gallery/g27159.jpg', alt: 'Looking up at black ABS drain pipe, a plastic hanger and a flexible line, with lumps of spray foam packed around them', width: 560, height: 747 },
      { file: '/img/gallery/g27152.jpg', alt: 'A wood-framed vent opening with leaves and debris in it, above pea gravel and soil in a crawlspace', width: 560, height: 747 },
  ...
  },
  {
    ...
    images: [
      ...
      { file: '/img/gallery/g27171.jpg', alt: 'A dark gap between boards of a home\'s lap siding', width: 560, height: 560 },
      ...
      { file: '/img/gallery/g27087.jpg', alt: 'Head-on view of the same white vent guard, its perforated metal screen curved over the opening and screwed to lap siding', width: 560, height: 420 },
      ...
      { file: '/img/gallery/g27085.jpg', alt: 'A foil-faced insulated duct pressed against a concrete foundation wall, a gap between them and fiberglass above', width: 560, height: 420 },
      ...
      { file: '/img/gallery/g27080.jpg', alt: 'The gap under the door of a shed, where the board siding stops short of the slab edge, bark mulch and fir needles pushed up against it', width: 560, height: 420 },
      { file: '/img/gallery/g27077.jpg', alt: 'A gray flexible hose with a black end fitting lying in bark mulch against a home\'s siding, drip stains above', width: 560, height: 420 },
      { file: '/img/gallery/g27073.jpg', alt: 'A gap where a door threshold meets a concrete slab', width: 560, height: 420 },
      { file: '/img/gallery/g27061.jpg', alt: 'Concrete-block piers and wood posts in a crawlspace, wrapped in plastic sheeting, with shredded yellow fiberglass all around', width: 560, height: 420 },
    ],
  },
  {
    key: 'commercial',
    ...
    images: [
      ...
      { file: '/img/gallery/g27203.jpg', alt: 'Inside a pole-barn metal fabrication shop: timber trusses, a worker at a bench, a welding helmet and a tube bender up front', width: 560, height: 995 },
  ...
  },
  {
    ...
    images: [
      ...
      { file: '/img/gallery/g27169.jpg', alt: 'A wrapped compact van parked on a gravel pull-off beside a guardrail, with water and tall evergreens behind it', width: 560, height: 560 },
      { file: '/img/gallery/g26871.jpg', alt: 'A technician standing with treatment equipment at a home', width: 560, height: 746 },
      { file: '/img/gallery/g27236.jpg', alt: 'A wrapped pickup with a canopy and ladder rack on a shaded driveway among tall evergreens, a small green building behind', width: 560, height: 420 },
      ...
      { file: '/img/gallery/g27141.jpg', alt: 'A wrapped pickup with a canopy parked at the curb of a residential street on an overcast day, other cars behind it', width: 560, height: 420 },
  ...
  },
  {
    ...
    images: [
      ...
      { file: '/img/gallery/g27107.jpg', alt: 'A velvet-antlered buck standing in landscaping of low juniper and bark mulch, with conifers behind', width: 560, height: 747 },
      ...
      { file: '/img/gallery/g27102.jpg', alt: 'A velvet-antlered buck bedded down among shrubs and ferns behind a strip of bark mulch', width: 560, height: 747 },
      { file: '/img/gallery/g27081.jpg', alt: 'A young deer lying down at the edge of a lawn, in front of shrubs and fallen leaves', width: 560, height: 747 },
      ...
      { file: '/img/gallery/g26991.jpg', alt: 'Two deer under a raised deck, one standing and one lying down, beside a wire cage and a folding metal chair', width: 560, height: 420 },

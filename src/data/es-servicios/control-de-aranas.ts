  ...
  secciones: [
    ...
    },
    {
      ...
      parrafos: [
        ...
        'Es además un animal útil de tener cerca. Es territorial, consume un volumen constante de insectos, y se come a otras arañas. Lo que no le vamos a decir es que caza a la araña vagabunda, que es la versión que circula y que no podemos respaldar con una fuente. Lo que sí tiene fuente es la observación de la extensión de la Universidad de California de que en partes del noroeste del Pacífico la araña doméstica gigante desplazó por competencia a la araña vagabunda. Esa observación está en la [nota sobre arañas de UC IPM](https://ipm.ucanr.edu/PMG/PESTNOTES/pn7488.html). Pase lo que pase entre las dos, la forma práctica es que donde la grande e inofensiva está bien establecida, la que carga con la fama es más escasa.',

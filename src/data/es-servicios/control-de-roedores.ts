  ...
  secciones: [
    ...
    },
    {
      ...
      parrafos: [
        ...
        'Y es también el número correcto para las ratas, cosa que sorprende a la gente, porque todas las fuentes de extensión universitaria dan una cifra más grande para el animal en sí. La extensión de Nebraska, eXtension, [UC IPM](https://ipm.ucanr.edu/home-and-landscape/rats/) y la de WSU ponen a la rata en poco más de media pulgada y al ratón en poco más de un cuarto. Lo que concilia las dos cosas es cómo lo plantea el Departamento de Pesca y Vida Silvestre de Washington: a una rata le basta un agujero de un cuarto de pulgada para morderlo, agrandarlo y pasar. El umbral de exclusión no es la medida por donde cabe el animal. Es la medida a la que el animal puede meterle los dientes a una orilla y empezar a quitar material — y con incisivos que crecen sin parar, ese trabajo se hace. Una malla de media pulgada sobre una rejilla detiene a la rata y deja pasar al ratón; una de un cuarto detiene a los dos y además le quita a la rata la orilla que necesita.',
      ],
    },
    {

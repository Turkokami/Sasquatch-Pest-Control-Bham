  ...
  secciones: [
    ...
    },
    {
      ...
      parrafos: [
        ...
        'Las puertas y el movimiento de aire. Barredoras de puerta, puertas que cierran solas, cortinas de aire y malla en todo lo que abre hacia afuera. Esa lista no es nuestra: el [Código de Alimentos de la FDA](https://www.fda.gov/food/retail-food-protection/fda-food-code) nombra la malla, la puerta que cierra sola y la cortina de aire como la manera de proteger una abertura al exterior.',

  ...
  secciones: [
    ...
    },
    {
      ...
      parrafos: [
        ...
        'Principios del otoño es la visita crítica: cuando el suelo se satura a finales de septiembre y en octubre, los roedores se meten, empujados por el agua más que por el frío, y esta visita es la que evita un invierno con roedores — y la razón de que el calendario no sea parejo. Las [normales climáticas de Estados Unidos](https://www.ncei.noaa.gov/access/us-climate-normals/) de la NOAA muestran lo empinado que sube aquí la lluvia mensual promedio entre el final del verano y octubre, y a esa subida responden los animales. A mitad del otoño llegan los insectos que buscan dónde pasar el invierno, amontonados en las paredes que dan al sur. Y el invierno, callado afuera, es el momento de la conversación estructural: qué está haciendo el espacio bajo el piso, dónde están las rendijas y qué conviene sellar antes de la primavera.',
      ],
    },
    {

...
export const lyndenNorthPrairie: EsLugar = {
  ...
  secciones: [
    ...
    },
    {
      ...
      parrafos: [
        'En una lechería el control de moscas es primero manejo de material y después tratamiento, y quien empieza por las moscas adultas empezó en el lugar equivocado. La mosca doméstica y la de los establos se crían en el estiércol, la cama sucia, el ensilaje echado a perder en la cara del silo, el alimento regado en el comedero y las orillas mojadas de bebederos y drenajes; el desarrollo empieza en cuanto el material se calienta, mucho antes de que alguien note adultas, y cuando se ven en cantidad en la sala de ordeña ya hay varias generaciones detrás. Lo que funciona es aburrido y eficaz: mover el material, voltear la cama y atender los criaderos temprano, y la razón para que importe más allá de la comodidad es la producción. Nada de eso lo inventamos: la [Extensión de WSU en el condado de Whatcom](https://extension.wsu.edu/whatcom/) lleva años diciéndoles lo mismo a las lecherías. Y en una granja lo que se puede aplicar y dónde lo decide la etiqueta, no la preferencia: una etiqueta es un documento legal, y un producto aprobado para un perímetro o un cobertizo muchas veces no lo está cerca del alimento, el agua o los animales. Le mostramos la etiqueta, cada producto que manejamos está publicado en el sitio con su registro de la EPA, y donde no se puede aplicar nada lo decimos y usamos exclusión, trampas y manejo de material.',
      ],
    },
    {
